package s3_gps_ivanti.configuration.security.isauthenticated;
...
public class IsAuthenticatedAspect {
    ...
    @Pointcut("@annotation(s3_gps_ivanti.configuration.security.isauthenticated.IsAuthenticated)")
    public void annotatedMethod() {
    }

    @Pointcut("@within(s3_gps_ivanti.configuration.security.isauthenticated.IsAuthenticated)")
